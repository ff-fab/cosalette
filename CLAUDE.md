...
Read and follow these project instruction files:

- [AGENTS.md](AGENTS.md) — Issue tracking (beads), commit conventions, session
  completion
...
- [.github/instructions/documentation.instructions.md](.github/instructions/documentation.instructions.md)
  — Markdown, Zensical, ADR format
- [.github/skills/pre-pr-gate/SKILL.md](.github/skills/pre-pr-gate/SKILL.md) — Pre-PR
