...
version = setuptools_scm.get_version(root=workspace_root, fallback_version="0.0.0")  # ty: ignore[possibly-unresolved-reference]
version_file = workspace_root / "packages" / "src" / "cosalette" / "_version.py"
