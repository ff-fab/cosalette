...
| F-DP1 | `error_type_map` conflates labeling with message disclosure | HARDENING | Med-Low | 209/532 | **Fixed** (ADR-061, corrective amendment 2026-08-27: opt-in `disclose_messages_for` set decouples message disclosure from labeling; `None` preserves legacy behaviour, default flip targeted for 0.7.0) |
