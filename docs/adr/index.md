...
| [ADR-047](ADR-047-source-module-hierarchy-move-remaining-root-level-modules-into-subpackages.md) | Source module hierarchy: move remaining root-level modules into subpackages | Accepted | 2026-05-10 |
