...
> **Purpose:** This document is a self-contained brief for an AI image-generation tool
> (ChatGPT / DALL-E / Midjourney). It contains everything needed to produce a cohesive
> visual identity for the cosalette framework: positioning, color system, asset specs,
> and embedding guidance. Hand this file to ChatGPT as-is.
...
| 404 page               | Default Zensical 404                       | Keep default (low priority)        |
...
| 6 | **GitHub social preview** | P1       | PNG                   | 1280×640            | Single version           |
